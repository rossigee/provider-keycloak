...
//go:generate go run -tags generate sigs.k8s.io/controller-tools/cmd/controller-gen crd:crdVersions=v1 paths=./v1beta1 paths=./clientinitialaccess/v1alpha1 paths=./component/v1alpha1 paths=./identityprovider/v1alpha1 paths=./keys/v1alpha1 paths=./rolemappings/v1alpha1 paths=./scopes/v1alpha1 output:artifacts:config=../package/crds
