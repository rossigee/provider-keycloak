...
type ClientParameters struct {
	...
	// WriteToSecretRef references a Kubernetes secret containing the client secret
	// to be pushed to Keycloak. If set, the value from this secret will be used
	// as the client secret instead of letting Keycloak generate one.
	// Cannot be used together with ReadFromSecretRef.
	// +optional
	WriteToSecretRef *SecretRef `json:"writeToSecretRef,omitempty"`

	// ReadFromSecretRef references a Kubernetes secret that will receive the
	// client secret generated by Keycloak. The secret will be populated after
	// client creation. Use this to sync the generated secret to external systems.
	// Cannot be used together with WriteToSecretRef.
	// +optional
	ReadFromSecretRef *SecretRef `json:"readFromSecretRef,omitempty"`

	// ClientSecretSecretRef references the Kubernetes secret that will receive the generated client secret.
	// Deprecated: Use ReadFromSecretRef instead. This field behaves the same way.
	// +optional
...
// SecretRef references a Kubernetes secret key holding a client secret.
...
type ClientSecretSecretRef = SecretRef
...
// +kubebuilder:group=openidclient.keycloak.m.crossplane.io
