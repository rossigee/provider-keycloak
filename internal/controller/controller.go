...
func setupRBAC(c k8sclient.Client, l logging.Logger) error {
	...
	rules := []rbacv1.PolicyRule{
		...
		{APIGroups: []string{"authenticationflow.keycloak.m.crossplane.io"}, Resources: []string{"authenticationflows", "authenticationflows/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"authorizationpolicy.keycloak.m.crossplane.io"}, Resources: []string{"authorizationpolicies", "authorizationpolicies/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"authz.keycloak.m.crossplane.io"}, Resources: []string{"authzresources", "authzresources/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"clientcertificates.keycloak.m.crossplane.io"}, Resources: []string{"clientcertificates", "clientcertificates/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"openidclient.keycloak.m.crossplane.io"}, Resources: []string{"clientdefaultscopes", "clientdefaultscopes/status", "clientoptionalscopes", "clientoptionalscopes/status", "clients", "clients/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"clientinitialaccess.keycloak.m.crossplane.io"}, Resources: []string{"clientinitialaccesses", "clientinitialaccesses/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"rolemappings.keycloak.m.crossplane.io"}, Resources: []string{"clientrolemappings", "clientrolemappings/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"scopes.keycloak.m.crossplane.io"}, Resources: []string{"clientscopemappings", "clientscopemappings/status", "clientscopes", "clientscopes/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"component.keycloak.m.crossplane.io"}, Resources: []string{"components", "components/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"group.keycloak.m.crossplane.io"}, Resources: []string{"groups", "groups/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		...
		{APIGroups: []string{"realm.keycloak.m.crossplane.io"}, Resources: []string{"realms", "realms/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
		{APIGroups: []string{"role.keycloak.m.crossplane.io"}, Resources: []string{"roles", "roles/status"}, Verbs: []string{"get", "list", "watch", "update", "patch", "create"}},
